...
detalhes técnicos podem consultar o [modelo de informação](mi-ria-r)
correspondente.
...
_relatesTo_. Esta propriedade é comentada na seção [Substituição de um registro](mc-ria-r#substituição-de-um-registro).
